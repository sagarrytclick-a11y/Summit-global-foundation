...
const BtechCollegeSlugPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCollegeBySlug = async () => {
      try {
        ...
        const response = await fetch('/btech.json');

        if (!response.ok) {
          throw new Error('Failed to fetch college data');
        }

        const data: BtechData = await response.json();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-linear-to-r from-blue-700 to-blue-900 text-white py-16 relative overflow-hidden">
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed text-lg">
                      {college.name} is a premier {college.type} engineering institution located in {college.city}. 
                      It is recognized by {college.recognition} and consistently ranked among the top engineering colleges in India, 
                      currently holding the {college.ranking} position. The college offers a world-class environment for 
                      engineering aspirants with {college.seats} seats available for the BTech program.
                    </p>
                  </div>
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="prose prose-blue max-w-none text-gray-600 leading-relaxed">
                    <p className="text-lg mb-6">
                      {college.admissionProcess || "Admission to the BTech program is strictly based on the performance in JEE Main / JEE Advanced or the respective state-level entrance examination."}
                    </p>
                    ...
                    <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
                      ...
                      <div className="space-y-6">
                        {[
                          { step: "Entrance Exam", desc: "Qualify the national or state-level engineering entrance exam with required percentile." },
                          { step: "Counseling Registration", desc: "Register on the official counseling portal (JoSAA/CSAB for central or state DTE)." },
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="p-6 border border-gray-100 rounded-xl shadow-sm">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(college.entranceExams || ["JEE Main", "JEE Advanced"]).map((exam, idx) => (
                      ...
                      <div className="p-6 border border-gray-100 rounded-xl shadow-sm">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          Minimum 75% in Class 12 (PCM) for General category (65% for SC/ST). Age limit as per JEE guidelines.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
                    <p className="text-xl font-medium leading-relaxed mb-6 opacity-90 italic">
                      &ldquo;{college.placements || "Graduates from this institution are well-placed in top tech companies across India and abroad, with many pursuing higher education in premier institutes."}&rdquo;
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                      ...
                      <div className="text-center p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                        ...
                        <div className="text-xs uppercase tracking-wider opacity-70 font-semibold">Company Visits</div>
                      </div>
                      <div className="text-center p-4 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        Students undergo industry internships in leading tech companies, gaining hands-on experience 
                        in software development, core engineering, and research across various domains.
                      </p>
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-gray-900 mb-4">Higher Education & Careers</h4>
                      <p className="text-gray-600 leading-relaxed">
                        The institute provides an excellent foundation for GATE, CAT, GRE, and placements. 
                        A significant percentage of students secure positions in top product-based companies 
                        or pursue MTech/MS at premier institutes.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
              <div className="p-6 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
                ...
                <p className="text-blue-100 text-sm mb-6">Expert guidance for JEE counseling and college selection.</p>
                <button 
                  onClick={() => {
                    updateFormData({ 
                      courseInterest: `${college.name} - BTech` 
                    });
                    openPopup();
                  }}
                ...
                <div className="space-y-4">
                  {relatedColleges.map((relatedCollege) => (
                    <Link 
                      ...
                      href={`/colleges/btech/${getCollegeSlug(relatedCollege.name)}`}
...
export default BtechCollegeSlugPage;
