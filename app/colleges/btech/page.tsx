...
const BtechPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        let data: BtechData | null = null;
        try {
          const res = await fetch("/btech.json");
          if (res.ok) {
            data = await res.json();
          }
        } catch {
      ...
      <section className="relative bg-gradient-to-br from-[#0b0e24] via-[#141838] to-[#1e2259] py-20 lg:py-24 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <nav className="flex items-center gap-2 text-sm text-blue-200/60 mb-6">
            ...
            <span>/</span>
            <span className="text-white font-medium">BTech</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-lg mb-6">
                <FaGraduationCap className="text-[#009edb] text-sm" />
                <span className="text-xs font-bold tracking-wider text-white/90 uppercase">Engineering Directory 2026</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-6 leading-tight tracking-tight">
                Top <span className="text-[#009edb]">BTech Colleges</span> in India
              </h1>
              <p className="text-base sm:text-lg text-blue-100/70 leading-relaxed max-w-xl mb-8">
                Discover top government &amp; private engineering colleges for BTech with complete
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="bg-[#141838]/60 border border-white/5 rounded-xl p-4 flex items-center justify-between">
                  <span className="text-sm text-blue-100/70 font-medium">Listed Engineering Colleges</span>
                  <p className="text-2xl font-black text-[#009edb]">{allColleges.length}</p>
                </div>
                <div className="bg-[#141838]/60 border border-white/5 rounded-xl p-4 flex items-center justify-between">
                  <span className="text-sm text-blue-100/70 font-medium">Available BTech Seats</span>
      ...
      <section className="bg-white border-b border-gray-100 relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: FaClipboardCheck, text: "JEE Main & Advanced Guidance" },
            ...
            {[
              {
                ...
                icon: FaCheckCircle,
                title: "JEE Qualified",
                desc: "Ensure you meet JEE eligibility and secure a qualifying score.",
              },
              {
                step: "02",
                icon: FaClipboardCheck,
                title: "Counselling & Docs",
                desc: "Complete JEE counselling registration and document verification.",
              },
              {
                step: "03",
                icon: FaCogs,
                title: "Secure Engineering Seat",
                desc: "Get seat allotment and complete admission at your engineering college.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 pb-6 border-b border-gray-100">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#1e2259] px-3 py-1.5 rounded-md mb-3">
              <span className="text-xs font-bold tracking-wider text-white uppercase">Engineering College Directory</span>
            </div>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col justify-between flex-1">
                    ...
                    <div className="mt-auto">
                      ...
                      <Link
                        href={`/colleges/btech/${college.name
                          .toLowerCase()
                          .replace(/[^a-z0-9\s]/g, "")
                          .replace(/\s+/g, "-")}`}
        ...
        <div className="bg-gradient-to-br from-[#0b0e24] via-[#141838] to-[#1e2259] rounded-2xl p-8 sm:p-14 text-center text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-4 tracking-tight">
              Need BTech Admission Guidance?
            </h2>
            <p className="text-blue-100/70 text-sm sm:text-base max-w-2xl mx-auto mb-8 leading-relaxed">
              Get expert counseling for JEE Main & Advanced, choice-filling strategy, documentation, and personalized guidance from our engineering admission experts.
            </p>
